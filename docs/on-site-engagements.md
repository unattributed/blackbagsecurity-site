...
description: On-site security engineering engagements with scoped access, safety controls, and evidence-driven reporting.
    ...
    <div class="split">
      ...
      <div class="stack stack--signal stack--safety reveal delay-2" data-reveal>
        ...
        <ul class="outcomes">
          ...
          <li>Activity pauses when risk exceeds agreed thresholds.</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="wrap">
    <div class="split">
      <div class="stack stack--signal stack--evidence reveal delay-1" data-reveal>
        ...
        <ul class="outcomes">
          <li>Collection is minimized to what is required to support material conclusions.</li>
          <li>Evidence exports can include collection and transfer context where the engagement requires it.</li>
          ...
          <li>In-country or residency constraints can be incorporated where operationally feasible and agreed in advance.</li>
        </ul>
      </div>
      <div class="stack stack--signal stack--transparency reveal delay-2" data-reveal>
        <h3>Communication and reporting</h3>
        <ul class="outcomes">
          <li>Communication cadence is agreed with technical leads and engagement owners.</li>
          <li>Critical findings or unexpected operational impact are escalated promptly.</li>
          <li>Draft findings can be reviewed for technical context before finalization.</li>
          <li>Remediation validation or retest can be included where it adds value.</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="wrap">
    <div class="split">
      ...
      <div class="stack stack--signal stack--secure reveal delay-2" data-reveal>
        ...
        <p>Execution and evidence handling can be tailored to sector controls, privacy requirements, and transfer restrictions.</p>
        <p>Legal interpretation should come from the client's counsel or compliance team. Black Bag Security aligns operations to approved requirements and documented constraints.</p>
        <p class="mono"><a href="{{ '/contact/#assessment' | relative_url }}">Discuss an on-site scope -></a></p>
      </div>
    </div>
  </div>
</section>
